...
def find_and_crop(image_file):
    ...
    faces = face_cascade.detectMultiScale(ar_image2, 1.3, minNeighbors=4, minSize=(25, 25), maxSize=(270, 270),
...
keyword = input(
    'please enter a word you wish to find on a newspaper page, which will then output a contact sheet of cropped face images on the same page: ')
